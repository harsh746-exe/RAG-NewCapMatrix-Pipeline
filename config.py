...
class Config:
    ...
    OUTGOING_DIR = os.path.join(SCRIPT_DIR, "outgoing")
    VECTOR_STORE_PATH = os.path.join(SCRIPT_DIR, "vector_store")
    
    # Input/Output files
    EXCEL_PATH = os.path.join(OUTGOING_DIR, "requirements_matrix.xlsx")
    OUTPUT_JSON = os.path.join(SCRIPT_DIR, "rag_requirement_matches.json")
    CHECKPOINT_FILE = os.path.join(SCRIPT_DIR, "rag_checkpoint.json")
    OUTPUT_EXCEL = os.path.join(SCRIPT_DIR, "rag_requirement_analysis_results.xlsx")
